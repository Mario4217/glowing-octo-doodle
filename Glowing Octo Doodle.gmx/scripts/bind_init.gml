...
keymap[? vk_numpad0] = "key.num0";
keymap[? vk_numpad1] = "key.num1";
keymap[? vk_numpad2] = "key.num2";
keymap[? vk_numpad3] = "key.num3";
keymap[? vk_numpad4] = "key.num4";
keymap[? vk_numpad5] = "key.num5";
keymap[? vk_numpad6] = "key.num6";
keymap[? vk_numpad7] = "key.num7";
keymap[? vk_numpad8] = "key.num8";
keymap[? vk_numpad9] = "key.num9";
