...
with (obj_menu){
  ...
  ui_add_child(menu_play_packs, ui_create_label(0,0,1,0.1,"{menu.play.new_note}"));
  ...
  while(filename != ""){
    ...
    var btn = ui_add_child(parent, ui_create_button(0,v,1,v+0.1,name,'pack_start "'+string(name)+'"'));
